...
public class CorvetteCore : MonoBehaviour
{
    ...
    [SerializeField]  private GameObject shipPivot;
    ...
    void Update()
    {
        ...
        //body.rotation = Quaternion.Euler(0f, rotation, rudder * Mathf.Abs(RudderEffectiveness(speed, rudderMaxEffectSpeed) * (speed / speedMaxFwd)) * 0.45f);
        ////body.position += shipPivot.transform.forward * speed * Time.deltaTime;
        //body.AddForce(shipPivot.transform.forward * speed, ForceMode.Acceleration);
    }
